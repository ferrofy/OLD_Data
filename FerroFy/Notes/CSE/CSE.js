const Topics = {
    ...
    "About System": [
        { Name: "OS", Icon: "fa-solid fa-code" },
        { Name: "Hardware", Icon: "fa-solid fa-code" },
        { Name: "Linux", Icon: "fa-solid fa-code" },
        { Name: "Windows", Icon: "fa-solid fa-code" }
    ],

    "Basic Tools": [
        { Name: "VS Code", Icon: "fa-solid fa-code" },
        { Name: "Antigravity", Icon: "fa-solid fa-code" },
        { Name: "CodeX", Icon: "fa-solid fa-code" },
        { Name: "Git", Icon: "fa-solid fa-code" },
        { Name: "GitHub", Icon: "fa-solid fa-code" }
    ],    
